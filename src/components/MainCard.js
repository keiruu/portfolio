...
export default function MainCard() {
    return (
        <div className="relative flex flex-col items-center justify-center z-10">
            <Nav/>
            <motion.div className="mt-14 relative glass rounded-3xl p-20 px-20 md:px-32 shadow-none text-center text-pink font-inter"
            ...
            >
                ...
                >
                    ...
                    <button className="hover:mb-2 transform transition duration-500 ease-in-out hover:-translate-y-1.5 transition-all border-2 border-pink bg-pink text-white p-4 px-8 md:px-10 rounded-lg">resume</button>
                </motion.div>
            </motion.div>
        </div>
    )
